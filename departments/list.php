                    ...
                    <?php if($_SESSION['adminID'] == 1):?>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item text-primary" href="/authproject/departments/update.php?edit=<?= $data['ID'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a class="dropdown-item text-danger" href="/authproject/departments/list.php?delete=<?= $data['ID'] ?>"><i class="fa-solid fa-trash-can"></i></a>
                            </div>
                        </div>
